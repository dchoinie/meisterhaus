      ...
      <Container>
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
          {testimonialsArray.map((t: Testimonial, i: number) => (
            <Card
              key={`${t.name}-${i}`}
              className={`p-6 bg-primary-50 text-[12px] break-inside-avoid-column inline-block w-full ${
                i === 0 ? "mt-6" : ""
              }`}
            >
              <CardContent className="text-primary-800">
                {t.testimonial}
              </CardContent>
              <CardFooter>
                <div className="flex justify-between w-full text-primary-800 font-cinzel-decorative">
                  <div className="flex">
                    <div className="bg-primary-800 rounded-full p-2 flex items-center justify-center mr-3">
